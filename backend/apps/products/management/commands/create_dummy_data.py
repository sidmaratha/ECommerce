...
class Command(BaseCommand):
    help = 'Create dummy data for the e-commerce platform'
    ...
    def handle(self, *args, **options):
        ...
        for cat_data in categories_data:
            ...
            if created:
                ...
                self.stdout.write(f'ℹ️ Category already exists: {cat_data["name"]}')
        ...
        for banner_data in banners_data:
            if not Banner.objects.filter(title=banner_data['title']).exists():
